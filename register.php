...
*/
$ok = NULL;
if ($registrar=="registro") {
	//echo "<br>###ENTRÓ 1###";
	if ( $nombre==NULL || $apellidos==NULL || $password==NULL || $correo==NULL ) {
        ...
        if ($customCheck1==false)
        {
			...
			### Verificar correo ###				
			$sql = "SELECT correo FROM usuarios WHERE correo = '" . trim($correo) . "'";
			//echo "SQL "; var_dump($sql);
			$result = $conn->query($sql);
			if ($result->num_rows > 1) {
				$msg="El correo que está tratando de dar de alta ya existe, verifique sus datos. Si no recuerda su contraseña puede recuperarla <a href=\"recuperar.php\">aquí</a>.";
				$class="alert alert-info";
			} else {
				if ($password != $vpassword) {
					...
					if (validar_pass($password, $error_encontrado)){
						...
						$activo = 1;
						$fecha = date("Y-m-d");
						$sql = " INSERT INTO usuarios (nombre, apellidos, correo, password, telefono, celular, ciudad, cp, direccion, referencias, imagen, activo, fecha ) 
						VALUES ('$nombre', '$apellidos', '$correo', '$pass', '$telefono', '$celular', '$ciudad', '$cp', '$direccion', '$referencias', '$imagen', '$activo', '$fecha') ";
						//echo "SQL: "; var_dump($sql);
						if ($conn->query($sql) === TRUE) {
							...
							$asunto = "Registrado con exito en www.tienda.luliygabo.com";
									  ...
									  <tr>
										<td align="center"><table width="650" border="0" cellspacing="0" cellpadding="0">
										  ...
										  <tr>
											...
											<h1 style="font-size:25px; font-weight:500">REGISTRO EXITOSO</h1>
											</td>
										  </tr>
										  <tr>
											...
											<td><table width="100%" border="0" cellspacing="0" cellpadding="0">
											  <tr>
												...
												<td width="489" align="left"><table width="100%" border="0" cellspacing="0" cellpadding="0">
												  <tr>
													<td colspan="2" style="font-size:14px; text-align:justify">Gracias por tu registro en la Tienda de Luli y Gabo. Ahora puedes entrar a comprar tus productos sin problema y de una manera más rápida. <br>
													  <br></td>
												  </tr>
												  </table></td>
												<td width="10">&nbsp;</td>
										  ...
										  <tr>
											<td height="30"><table width="100%" border="0" cellspacing="0" cellpadding="0" style="font-size:14px;">
											  ...
											  <tr>
												<td width="10">&nbsp;</td>
												<td width="387" align="left"><strong>Tu Contraseña: '.$password.'</strong></td>
    ...
    <div class="wrapper">
        ...
        <div class="register-box col-md-4 col-lg-4 col-sm-6 col-xs-10 mb-55">
			...
			<form id="contact-form" action="register.php" method="post">
				...
				<div class="single-contact-form">
					<div class="contact-box subject">
						<input type="password" name="vpassword" placeholder="verificar password">
					</div>
				</div>

				<div class="single-contact-form" style="margin-top: 10px;">
				<input type="checkbox" name="customCheck1" id="customCheck1"> Acepto los <a style="color:#fff" target="_blank" href="tyc.php">Términos y Condiciones</a>
				</div>
			   
				<div class="contact-btn">
					<button type="submit" class="fv-btn" name="registrar" value="registro">CREAR UNA CUENTA</button>
				</div>
				<?
				}
				?>
			...
			<div style="text-align:center">
				...
				<div class="contact-btn">
					<a href="login.php" class="rg-btn">Entrar</a>
				</div>	
				<?
				}
				?>
