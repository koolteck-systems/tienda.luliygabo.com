	...
	$(document).ready(function() {
		$('body').on('click', '#pagar', function(){
			if(validarForm()) {
				...
				alert("ERROR: Le falta iniciar sesión y llenar los datos. Verifique los mensajes de alerta en rojo.");
				return false;
			}
		});
	});
...
<body>
    ...
    <div class="wrapper">
        	...
        	<div class="cart-main-area pt--30 pb--10 bg__white">
        		<div class="container">
        			<div class="row">
        				<div class="col-md-8 col-sm-8 col-xs-12 address">
							...
							<form id="contact-form" action="" name="formContact" method="post">
								<div style="margin-bottom: 30px; font-size: 18px; line-height: 18px;">
									<span style="color: #ff5a33;"><b>Importante:</b></span> para poder realizar una compra tienes que <a href="login.php?seccion=cart" style="color:red;">iniciar sesión</a> y guardar tus datos de envío.
								</div>
								...
								<div class="single-contact-form">
									<div class="contact-box name">
										...
										<input type="text" name="colonia" id="colonia" placeholder="Colonia" value="">">
									</div>
								</div>
